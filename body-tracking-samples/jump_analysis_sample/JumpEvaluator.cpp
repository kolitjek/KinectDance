...
#pragma endregion
    ...
    if (m_jumpStatus == JumpStatus::CollectJumpData)
    {
       ...
       // printf("bodyid [ %zu ] timestamp [ %zu ]\n", selectedBody.id, currentTimestampUsec);

        printf("( ");
        printf("%.6f", selectedBody.skeleton.joints[0].position.v[0]);
        printf(", ");
        printf("%.6f", selectedBody.skeleton.joints[0].position.v[1]);
        printf(", ");

        printf("%.6f", selectedBody.skeleton.joints[0].position.v[2]);
        printf(" )");
        printf("\n");
